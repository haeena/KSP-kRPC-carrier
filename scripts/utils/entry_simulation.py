...
class entry_simulation(object):

    def __init__(_initialOrbit:Orbit, _UT: float, _vessel: Vessel,
                 _simcurves: SimCurves, _descentSpeedPolicy: IDescentSpeedPolicy,
                 _decelEndAltitudeASL: float, _maxThrustAccel: float,
                 _parachuteSemiDeployMultiplier: float, _probableLandingSiteASL: float,
                 _multiplierHasError: float, _dt: float,  _min_dt:float,  _maxOrbits:float, _noSKiptoFreefall:bool):
