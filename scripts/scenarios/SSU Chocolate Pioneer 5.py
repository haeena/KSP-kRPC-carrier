...
def main():
    conn = krpc.connect(name='SSU Chocolate Pioneer 5')
    ...
    launch_into_orbit(conn, TARGET_ALTITUDE, TARGET_INCLINATION, auto_stage=False, use_rcs_on_circulization=True)
